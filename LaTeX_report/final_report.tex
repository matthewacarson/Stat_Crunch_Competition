...
Since \texttt{`Followers'} is highly skewed, the log of \texttt{`Followers'} was taken. A difference in means of the log followers was calculated.

\begin{equation}
\mu_{1} = Mean of ln(Followers) where Mature \newline
\mu_{2} = Mean of ln(Followers) where not Mature \\
