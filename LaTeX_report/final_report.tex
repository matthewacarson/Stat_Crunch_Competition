...
%  \centering
%  \begin{tabular}{|c|c|}
%    \includegraphics[width=0.9\linewidth]{../StatCrunch_Results/reciprocal/table}
%  \end{tabular}
%  \caption{An image included in a table}
