...
\begin{figure}
  \centering
  \includegraphics[width=0.8\linewidth]{../StatCrunch_Results/followers_gained_stream_deciles}
  \captionsetup{justification=centering, singlelinecheck=false, margin=2cm}
