...
\begin{equation}
 \dfrac{1}{Average\ viewers_{i}} = 0.00004043631 + 0.0000091545008 \ast Mean\ weekly\ stream\ hours_{i} \label{eq:reciprocal_model_w_coef}
\end{equation}
...
\begin{equation}
Average\ viewers_{i} = \dfrac{1}{0.00004043631 + 0.0000091545008 \ast Mean\ weekly\ stream\ hours_{i}} \label{eq:back_transformed_reciprocal_eq}
\end{equation}
