...
\begin{figure}[H]
\centering
	\includegraphics[height=0.45\textheight]{../StatCrunch_Results/ln_followers_stream/plot}
	\captionsetup{justification=centering, singlelinecheck=false, margin=2cm}
