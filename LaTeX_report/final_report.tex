...
\begin{table}[H]
  \centering % width=\linewidth, height=\textheight
  \includegraphics[width=0.8\linewidth]{../StatCrunch_Results/followers_mature_watch_hrs/multi_regression_table}
  \captionsetup{justification=centering, singlelinecheck=false, margin=2cm}
  \caption[Multiple Linear Regression for Followers by Mature]{Multiple Linear Regression for Followers by Mature}
...
\begin{figure}[H]
  \centering % width=\linewidth, height=\textheight
  \includegraphics[width=0.8\linewidth, height = 0.5\textheight]{../StatCrunch_Results/mature/box_plots}
  \captionsetup{justification=centering, singlelinecheck=false, margin=2cm}
