...
\begin{table}[H]
  \centering
  \includegraphics[width=0.65\linewidth]{../StatCrunch_Results/table}
...
\begin{figure}[!b]
  ...
  \includegraphics[scale=0.55]{../StatCrunch_Results/followers_gained_stream_deciles/barplot}
  \captionsetup{justification=centering, singlelinecheck=false, margin=2cm}
  \caption[Followers Gained by Stream Time Deciles]{Followers Gained by Stream Time Deciles. (The lowest decile streamed the least.)}
...
%  \includegraphics[scale=0.8]{../StatCrunch_Results/reciprocal/regression_table}
...
\begin{wraptable}{l}{0.65\textwidth} % Adjust the width as needed
%    \centering
    \includegraphics[scale=0.8]{../StatCrunch_Results/reciprocal/regression_table}
