...
Since one usually does not have a particular interest in knowing what the reciprocal of the average number of viewers is, \texttt{`Average viewers'} was reverse transformed and the transformed equation was plotted over the data on their original scale.

% scatter_plot_reverse_transformed
%%%%%%%%%%%%%%%%%%%%%%%%
% Back transformed reciprocal
%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[H]
  \centering % width=\linewidth, height=\textheight
  \includegraphics[scale=0.5]{../StatCrunch_Results/reciprocal/scatter_plot_reverse_transformed}
  \captionsetup{justification=centering, singlelinecheck=false, margin=2cm}
  \caption[Back Transformed Average Viewers Predicted by Stream Hours]{Back Transformed Average Viewers Predicted by Stream Hours. The fitted line is Equation \ref{eq:back_transformed_reciprocal}}
  \label{fig:back_transformed_reciprocal}
\end{figure}

\begin{equation}
Average\ viewers_{i} = \dfrac{1}{4.04e^{-5} + 9.15e^{-6} \ast Mean\ weekly\ stream\ hours_{i}} \label{eq:back_transformed_reciprocal}
\end{equation}
%%%%%%%%%%%%%
