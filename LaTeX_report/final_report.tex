...
\begin{figure}[H]
\centering
	\includegraphics[scale=0.8]{../StatCrunch_Results/ln_followers_stream/plot}
	\captionsetup{justification=centering, singlelinecheck=false, margin=2cm}
...
\begin{figure}[H]
\centering
	\includegraphics[height=0.7\textheight]{../StatCrunch_Results/ln_followers_stream/scatter_small}
	\captionsetup{justification=centering, singlelinecheck=false, margin=2cm}
