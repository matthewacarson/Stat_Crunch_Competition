...
\begin{figure}[H]
\centering
	\includegraphics[width=0.9\linewidth]{../StatCrunch_Results/logit_partnered_followers/scatter_plot}
	\captionsetup{justification=centering, singlelinecheck=false, margin=2cm}
...
Lastly, whether an account is partnered on Twitch is best predicted by the number of followers that the account has. Additional variables did not add enough predictive power to warrant their inclusion in the model. 
