...
\begin{figure}[H]
  ...
  \captionsetup{justification=centering, singlelinecheck=false, margin=2cm}
  \caption[Back Transformed Average Viewers Predicted by Stream Hours]{Back Transformed Average Viewers Predicted by Stream Hours. The fitted line is Equation \ref{eq:back_transformed}}
  \label{fig:scatter_plot_reverse_transformed}
\end{figure}
